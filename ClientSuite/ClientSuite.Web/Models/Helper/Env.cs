...
namespace ClientSuite.Web
{
    ...
    public static class Env
    {
        ...
        public static DateTime GetTimeZoneInfo(DateTime datetime)
        {
            ...
            try
            {
                //var utcDate = Convert.ToDateTime(date.ToUniversalTime().ToString("s", System.Globalization.CultureInfo.InvariantCulture));
                string timeZone = Env.AppInfo("TimeZone", AppContext.Current.User.Claims).Value;
        ...
        //public static string CalenderDateFormat()
        //{
        ...
        public static string DateTimeValue(string appendTime = "")
        {
            return SetDefaultValueAsFormat(DateTime.Now, appendTime);
        }

        public static string ToDateTimeValue(this DateTime dateTime, string appendTime = "")
        {
            return SetDefaultValueAsFormat(dateTime, appendTime);
        }

        private static string SetDefaultValueAsFormat(DateTime dateTime, string appendTime)
        {
            if (CurrentCulture() == "en")
                return GetTimeZoneInfo(dateTime).ToString("yyyy/MM/dd" + appendTime);
            else
                return GetTimeZoneInfo(dateTime).ToString("dd/MM/yy" + appendTime);
        }


        public static IHtmlContent DateTimeCalender(string fieldName, string timepicker = "true", string format = "")
        {
            ...
            return new HtmlString("<script>$(function () { $('#" + fieldName + "').datetimepicker({ format: '" + format + "',timepicker:" + timepicker + " }); });</script>");
        }
