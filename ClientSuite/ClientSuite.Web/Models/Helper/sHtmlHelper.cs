...
namespace ClientSuite.Web
{
    public static class sHtmlHelper
    {
        ...
        public static IHtmlContent DataTableRowDelete(this IHtmlHelper htmlHelper, string TableName, string error = "you are unauthorized to delete data", string success = "Action Successfully Executed", string area = "")
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            ...
            sb.AppendLine("            {");
            sb.AppendLine("            $.ajax({");
            sb.AppendLine("                url: \"/" + area + TableName + "/Delete\",");
            sb.AppendLine("                type: \"Post\",");
            sb.AppendLine("                data: { 'Id': id },");
            sb.AppendLine("                success: function(data) {");
