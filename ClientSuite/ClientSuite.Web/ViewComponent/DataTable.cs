...
namespace ClientSuite.Web
{
    public class DataTable : ViewComponent
    {
        ...
        public HtmlString Invoke(string TableName, string[] Columns, string area="", string url="")
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();

            sb.AppendLine("       $(document).ready(function () {");
            sb.AppendLine("            var cName = \"/"+ area + TableName + "\";");
            ...
            sb.AppendLine("                    \"url\": '/" + area + TableName + "/GetGrid" + url + "',");
            ...
            sb.AppendLine("                                             <li><a data-toggle=\"modal\" href=\"/" + area + TableName + "/Edit/' + data + '\" data-target=\"#modal-action-base\"><i class=\"fa fa-edit\"></i>" + Localizer["Edit"] + "</a></li>\\");
