...
namespace ClientSuite.Service
{
    ...
    { 
        ...
        private IQueryable<AppSettingViewModel> FilterResult(string search, IQueryable<AppSettingViewModel> dtResult, List<string> columnFilters, int searchTake = 500)
        {
            ...
            if (!columnFilters.All(x => string.IsNullOrWhiteSpace(x)))
            {
                ...
                if (!string.IsNullOrEmpty(columnFilters[14]))
                    results = results.Where(p => p.Currency.ToString().ToLower().Contains(columnFilters[14].ToLower()));
        ...
        {
            _appSettingRepository.Delete(entity);
        }
        ...
        public void Insert(AppSetting entity)
        {
            _appSettingRepository.Insert(entity); 
        }

        public void Update(AppSetting entity)
        {
